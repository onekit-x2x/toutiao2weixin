...
export default class tt {
  ...
  // ////////////////// File //////////
  static getFileSystemManager(tt_object) {
    return wx.getFileSystemManager(tt_object)
  }

  static getFileInfo(tt_object) {
    return wx.getFileInfo(tt_object)
  }

  static removeSavedFile(tt_object) {
    return wx.removeSavedFile(tt_object)
  }
  ...
  static getSavedFileList(tt_object) {
    return wx.getSavedFileList(tt_object)
  }
  ...
  static login(tt_object) {
    ...
    const tt_object2 = {}
    tt_object2.success = function (res) {
      // eslint-disable-next-line no-undef
      ...
      if (tt_object.success) {
        tt_object.success(result)
      }
      if (tt_object.complete) {
        tt_object.complete(result)
      }
    }
    tt_object2.fail = function (res) {
      if (tt_object.fail) {
        tt_object.fail(res)
      }
      if (tt_object.complete) {
        tt_object.complete(res)
      }
    }
    if (tt._checkSession()) {
      tt_object2.success({
...
/////////////////////////////////
static getMenuButtonLayout(tt_object){
  return wx.getMenuButtonBoundingClientRect(tt_object)
}
  // /////////////////////////////////
  ...
  static exitMiniProgram(tt_tt_object) {
    const tt_success = tt_tt_object.success
    const tt_fail = tt_tt_object.fail
    const tt_complete = tt_tt_object.complete
    //
    wx.showToast({
